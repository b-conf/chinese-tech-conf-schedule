# 中文技术活动日程 Chinese Tech Events Schedule
...
不满足这些条件的活动的组织者仍然可以利用本repo的信息，避免和其他活动发生时间冲突。另外，有些情况下，一些不满足条件但对会议组织有比较大影响的活动也可以收录，比如诸如W3C TPAC的领域重要会议可能使得相关领域的讲师候选大规模缺席。
